...
class HennessyMilnerLogicTests extends AnyFunSpec with should.Matchers  {
  ...
  describe("The HML metric") {
    ...
    it(s"$ob1 should have coordinates (1,0,0,0,0,0)") {
    ...
    it(s"$ob2 should have coordinates (2,1,0,0,1,1)") {
    ...
    it(s"$ob3 should have coordinates (3,1,2,1,1,1)") {
    ...
    it(s"$conj1a should be cheaper than $conj1b") {
