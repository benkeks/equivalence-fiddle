...
object ObservationNotionWeak {
  ...
  val BaseLTBTS = List( 
    ...
    "weak-traces" ->                  ObservationNotionWeak(INFTY,     0,     0,     0,     0,     0,    0,    0,    0),
    "unstable-failure" ->        ObservationNotionWeak(INFTY,     0,     1,     0,     0,     0,    0,    1,    1),
    "weak-failure" ->                 ObservationNotionWeak(INFTY,     0,     0,     1,     0,     0,    0,    1,    1),
    "unstable-readiness" ->      ObservationNotionWeak(INFTY,     0,     1,     0,     0,     1,    0,    1,    1),
    "weak-readiness" ->               ObservationNotionWeak(INFTY,     0,     0,     1,     0,     1,    1,    1,    1),
    "weak-failure-trace" ->           ObservationNotionWeak(INFTY,     0,     0, INFTY,     0, INFTY,    0,    1,    1),
    "weak-ready-trace" ->             ObservationNotionWeak(INFTY,     0,     0, INFTY,     0, INFTY,    1,    1,    1),
