...
class GraphRenderer(val main: Control)
  ...
  val force = d3.forceSimulation[GraphNode](nodes)
      .force("charge", d3.forceManyBody[GraphNode]().strength(-12.0))
      .force("centerx", d3.forceX[GraphNode](350.0).strength(0.02))
      .force("centery", d3.forceY[GraphNode](350.0).strength(0.02))
